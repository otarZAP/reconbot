...
| 3 | **DC gear motors + wheels** | 2 | Drive — salvage from a toy/Arduino car kit |
| 4 | **18650 Li-ion cell** | 1 | Main battery |
| 5 | **18650 holder (single, wire leads)** | 1 | Holds the cell |
| 6 | **TP4056 Type-C charger w/ protection** | 1 | Charge + protect the cell |
| 7 | **TPS63020 / XL63020 buck-boost (3.3 V)** | 1 | Clean 3.3 V for the brain |
| 8 | **MT3608 boost converter** | 1 | 5 V for the motors |
| 9 | **Rocker switch (SPST)** | 1 | Master on/off |
| 10 | **Hookup wire / jumper wires** | — | Wiring |
| 11 | **Heatshrink, solder** | — | Tidy, durable joints |
| 12 | **3D-printed chassis + lid** | 1 set | Body + top cover (STLs included; wheels come from the car kit) |
